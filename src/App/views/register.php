...
<section class="max-w-2xl mx-auto mt-12 p-4 bg-white shadow-md border border-gray-200 rounded">
    <form method="POST" class="grid grid-cols-1 gap-6">
        ...
        <label class="block">
            ...
            <input value="<?php if (!empty($oldFormData['email'])) : echo e($oldFormData['email']);
                            endif; ?>" name="email" type="email" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" placeholder="john@example.com" />
        ...
        <label class="block">
            ...
            <input value="<?php if (!empty($oldFormData['age'])) : echo $oldFormData['age'];
                            endif; ?>" name="age" type="number" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" placeholder="" />
        ...
        <label class="block">
            ...
            <select name="country" class="block w-full mt-1 rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                ...
                <option value="Canada" <?php if (!empty($oldFormData['country'])) : echo $oldFormData['country'] === 'Canada' ? 'selected' : '';
                                        endif; ?>>Canada</option>
                <option value="Mexico" <?php if (!empty($oldFormData['country'])) : echo $oldFormData['country'] === 'Mexico' ? 'selected' : '';
                                        endif; ?>>Mexico</option>
        ...
        <label class="block">
            ...
            <input value="<?php if (!empty($oldFormData['socialMediaURL'])) : echo $oldFormData['socialMediaURL'];
                            endif; ?>" name="socialMediaURL" type="text" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" placeholder="" />
